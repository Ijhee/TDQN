...
class TDQN:
    ...
    def training(self, trainingEnv, trainingParameters=[],
        ...
        if plotTraining:
            ...
            #### 본인의 경로에 맞게 수정 필요  #####
            plt.savefig(''.join(['C:/Users/leejunhee/Downloads/An-Application-of-Deep-Reinforcement-Learning-to-Algorithmic-Trading-main\An-Application-of-Deep-Reinforcement-Learning-to-Algorithmic-Trading-main/Figures/', str(marketSymbol), '_TrainingTestingPerformance', '.png']))
            #plt.show()
            for i in range(len(trainingEnvList)):
    ...
    def testing(self, trainingEnv, testingEnv, rendering=False, showPerformance=False):
        ...
        while done == 0:
            ...
            Qvalues2.append(QValues[2])

        # If required, show the rendering of the trading environment
        if rendering:
            testingEnv.render()
            self.plotQValues(QValues0, QValues1, Qvalues2, testingEnv.marketSymbol)
    ...
    def plotQValues(self, QValues0, QValues1, Qvalues2, marketSymbol):
        """
        ...
        :param: - QValues0: Array of Q values linked to action 0.
                ...
                - Qvalues2: Array of Q values linked to action 2.
                - marketSymbol: Stock market trading symbol.
        ...
        ax1.plot(QValues1)
        ax1.plot(Qvalues2)
        ax1.legend(['Short', 'Long_50','Long_100'])
